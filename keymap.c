...
#define CMS_T CMB_021
#define CMS_S_R CMB_022
#define CMS_S_T CMB_023
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = MY_layout(
    ...
    EN_QUOT, TT_008, LA_EN, CMB_LYG, CMB_LYV,
    CMB_CTL, // LEFT RED THUMB KEY
    CMB_SFT, CMB_BSP, CMB_ENT, // LEFT THUMB KEYS

    // RIGHT HALF
    LA_RU,    EN_ASTR, EN_EXCL, EN_QUES, EN_HASH, EN_SLSH, CT_Z,
    ...
    CMB_CMS, EN_H,    EN_J,    EN_K,    EN_L,    EN_SCLN, EN_QUOT,
             EN_N,    EN_M,    EN_COMM, EN_DOT,  EN_SLSH, AC_TILD,
                      CMB_LYR, CMB_SLH, KC_ESC, TT_006,  TT_009,
  ...
  [1] = MY_layout(
    ...
    CMB_TLD, EN_S_Y,  EN_S_U,  EN_S_I,  EN_S_O,  EN_S_P,  EN_MINS,
    CMB_DLR, EN_S_H,  EN_S_J,  EN_S_K,  EN_S_L,  EN_COLN, EN_DQUO,
             EN_S_N,  EN_S_M,  EN_LT,   EN_GT,   EN_QUES, SFT_N,
  ...
  [2] = MY_layout(
    ...
    EN_QUOT, _______, LA_EN, CMB_LYG, CMB_LYV,
    CMB_CTL, // LEFT RED THUMB KEY
    CMB_SFT, CMB_BSP, CMB_ENT, // LEFT THUMB KEYS

    // RIGHT HALF
    LA_RU,    RU_ASTR, RU_EXCL, RU_QUES, EN_HASH, RU_SLSH, CT_Z,
    CMB_CTS, RU_N,    RU_G,    RU_SH,  RU_SC,   RU_Z,    RU_MINS,
    CMB_CMS, CMS_R,   RU_O,    RU_L,    RU_D,    RU_ZH,   RU_E,
             CMS_T,   RU_SF,   RU_B,    RU_JU,   RU_H,    RU_JO,
                      CMB_LYR, CMB_SLH, KC_ESC, _______, _______,
                      CMB_ALT, // RIGHT RED THUMB KEY
                      CMB_LAN, CMB_DOT, CMB_SPC // RIGHT THUMB KEYS
  ),
  ...
  [3] = MY_layout(
    ...
    CMB_TLD, RU_S_N,  RU_S_G,  RU_S_SH, RU_S_SC, RU_S_Z,  RU_MINS,
    CMB_DLR, CMS_S_R, RU_S_O,  RU_S_L,  RU_S_D,  RU_S_ZH, RU_S_E,
             CMS_S_T, RU_S_SF, RU_S_B,  RU_S_JU, RU_S_H,  RU_S_JO,
  ...
  [4] = MY_layout(
    ...
    _______, KC_TAB,  EN_GT,   AG_RPRN, AG_LPRN, EN_LT,   SH_TAB,
             EN_FISH, EN_GTEQ, EN_ARR2, EN_ARR1, EN_LTEQ, EN_CLTG,
                      ...
                      _______, // RIGHT RED THUMB KEY
                      CMB_CTC, CMB_CTV, CMB_SFT // RIGHT THUMB KEYS
    ),
  ...
  [7] = MY_layout(
    ...
    _______, _______, KC_TAB,  KC_LALT, _______,
    _______, // LEFT RED THUMB KEY
    _______, _______, _______, // LEFT THUMB KEYS
    ...
    _______, _______, CA_LEFT, _______, _______, CA_RGHT, _______,
             _______, CWN_LEFT,  _______, _______, CWN_RGHT,  _______,
                      _______, _______, _______, _______, _______,
                      _______, // RIGHT RED THUMB KEY
                      _______, _______, _______ // RIGHT THUMB KEYS
  ),
