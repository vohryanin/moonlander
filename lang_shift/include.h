...
enum lang_shift_keycodes {
	...
	LA_EN, /* Задаёт принудительное переключение языка на EN с использованием сочетания клавиш Ctrl+3. */
	LA_RU, /* Задаёт принудительное переключение языка на RU с использованием сочетания клавиш Ctrl+4. */
